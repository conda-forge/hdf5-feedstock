...
if "%mpi%"=="impi" (
  :: cmake try-compile gets confused by backslashes
  set _LIBRARY=%LIBRARY_PREFIX:\=/%
  echo "!LIBRARY_PREFIX! :: !_LIBRARY!"
  set "CMAKE_ARGS=!CMAKE_ARGS! --debug-output --debug-trycompile"
  set "CMAKE_ARGS=!CMAKE_ARGS! -D MPI_C_ADDITIONAL_INCLUDE_DIRS=!_LIBRARY!/include"
  set "CMAKE_ARGS=!CMAKE_ARGS! -D MPI_CXX_ADDITIONAL_INCLUDE_DIRS=!_LIBRARY!/include"
  set "CMAKE_ARGS=!CMAKE_ARGS! -D MPI_C_LIB_NAMES=IMPI"
  set "CMAKE_ARGS=!CMAKE_ARGS! -D MPI_CXX_LIB_NAMES=IMPI"
  set "CMAKE_ARGS=!CMAKE_ARGS! -D MPI_IMPI_LIBRARY=!_LIBRARY!/lib/impi.lib"
