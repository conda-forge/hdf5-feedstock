...
if [[ "$CONDA_BUILD_CROSS_COMPILATION" == 1 && $target_platform == "osx-arm64" ]]; then
  CMAKE_HDF5_OPTIONS="${CMAKE_HDF5_OPTIONS} -DH5_LDOUBLE_TO_LONG_SPECIAL_RUN=0"
  CMAKE_HDF5_OPTIONS="${CMAKE_HDF5_OPTIONS} -DH5_LONG_TO_LDOUBLE_SPECIAL_RUN=0"
  CMAKE_HDF5_OPTIONS="${CMAKE_HDF5_OPTIONS} -DH5_LDOUBLE_TO_LLONG_ACCURATE_RUN=1"
  CMAKE_HDF5_OPTIONS="${CMAKE_HDF5_OPTIONS} -DH5_LLONG_TO_LDOUBLE_CORRECT_RUN=1"
  CMAKE_HDF5_OPTIONS="${CMAKE_HDF5_OPTIONS} -DH5_DISABLE_SOME_LDOUBLE_CONV_RUN=1"
